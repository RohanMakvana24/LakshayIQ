            ...
            <div className="grid items-center gap-12 md:grid-cols-12 lg:gap-8">
              ...
              <div className="md:col-span-7 lg:col-span-6">
                ...
                <h1 className="mt-6 text-4xl font-extrabold leading-[1.15] tracking-tight sm:text-5xl lg:text-6xl">
                  Every <span className="bg-gradient-to-r from-emerald-400 to-teal-300 bg-clip-text text-transparent">Note, PYQ, Project & Resume</span> Your Semester Needs
                </h1>
                
                <p className="mt-6 max-w-xl text-base leading-relaxed text-emerald-100/70 sm:text-lg">
                  All-in-one platform: structured notes, question banks, video lessons, AI-powered resume builder, and final-year project guidance — built for Indian universities.
                </p>
                ...
                <div className="mt-8 flex flex-wrap items-center gap-4">
                  ...
                  <Button asChild variant="outline" size="lg" className="rounded-full border-white/20 bg-white/5 text-white hover:bg-white/10">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          ...
          <section className="bg-white py-12 text-center">
            ...
            <div className="mt-6 flex flex-wrap items-center justify-center gap-x-12 gap-y-6 opacity-40 grayscale contrast-200">
              <span className="text-sm font-bold tracking-tight text-slate-800">AKTU</span>
              <span className="text-sm font-bold tracking-tight text-slate-800">SPPU</span>
              <span className="text-sm font-bold tracking-tight text-slate-800">VTU</span>
              <span className="text-sm font-bold tracking-tight text-slate-800">GTU</span>
              <span className="text-sm font-bold tracking-tight text-slate-800">RTU</span>
            </div>
          </section>

          {/* FEATURES SECTION (Original) */}
          <section id="features" className="py-12 text-center">
            <p className="text-xs font-bold uppercase tracking-widest text-emerald-500">Academic Resources</p>
          ...
          {/* NEW SECTION: Resume Builder & Project Finder Tools */}
          <section id="tools" className="py-16 border-t border-slate-100">
            <div className="text-center max-w-2xl mx-auto mb-12">
              <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider bg-slate-100 text-slate-600">
                <Rocket className="w-3.5 h-3.5 text-emerald-500" /> Career Accelerators
              </span>
              <h2 className="text-3xl font-black tracking-tight text-slate-900 mt-3 sm:text-4xl">
                Build Your Future with Smart Tools
              </h2>
              <p className="text-sm text-slate-500 mt-2">
                From crafting a standout resume to finding the perfect final-year project — we've got you covered.
              </p>
            </div>
            ...
            <div className="grid gap-8 md:grid-cols-2">
              ...
              <Link 
                ...
                className="group relative rounded-3xl border border-slate-200 bg-white p-8 transition-all duration-300 hover:shadow-2xl hover:-translate-y-1 overflow-hidden"
              >
                <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-emerald-500/5 to-teal-500/5 rounded-bl-3xl" />
                <div className="relative z-10">
                  ...
                  <h3 className="mt-6 text-2xl font-extrabold text-slate-900 group-hover:text-emerald-600 transition-colors">
                    AI Resume Builder
                  </h3>
                  <p className="mt-3 text-sm text-slate-500 leading-relaxed">
                    Create ATS-friendly, professional resumes in minutes. Choose from 20+ templates, get AI-powered content suggestions, and download PDF instantly.
                  </p>
                ...
                <div className="mt-6 flex flex-wrap gap-2">
                  <span className="text-[10px] font-bold bg-slate-100 text-slate-600 px-2 py-1 rounded-full">AI Suggestions</span>
                  <span className="text-[10px] font-bold bg-slate-100 text-slate-600 px-2 py-1 rounded-full">20+ Templates</span>
                  <span className="text-[10px] font-bold bg-slate-100 text-slate-600 px-2 py-1 rounded-full">PDF Export</span>
                </div>
              </Link>
              ...
              <Link 
                ...
                className="group relative rounded-3xl border border-slate-200 bg-white p-8 transition-all duration-300 hover:shadow-2xl hover:-translate-y-1 overflow-hidden"
              >
                <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-indigo-500/5 to-purple-500/5 rounded-bl-3xl" />
                <div className="relative z-10">
                  ...
                  <h3 className="mt-6 text-2xl font-extrabold text-slate-900 group-hover:text-indigo-600 transition-colors">
                    Project Finder & Helper
                  </h3>
                  <p className="mt-3 text-sm text-slate-500 leading-relaxed">
                    Get end-to-end guidance for your final semester project: custom development, synopsis, reports, PPT, and viva preparation — all in one place.
                  </p>
                  <div className="mt-6 flex items-center gap-2 text-indigo-600 font-bold text-sm group-hover:gap-3 transition-all">
                    <span>Get Project Assistance</span>
                    <ArrowRight className="h-4 w-4 group-hover:translate-x-1 transition-transform" />
                  </div>
                </div>
                <div className="mt-6 flex flex-wrap gap-2">
                  <span className="text-[10px] font-bold bg-slate-100 text-slate-600 px-2 py-1 rounded-full">React/Next.js</span>
                  <span className="text-[10px] font-bold bg-slate-100 text-slate-600 px-2 py-1 rounded-full">Python/ML</span>
                  <span className="text-[10px] font-bold bg-slate-100 text-slate-600 px-2 py-1 rounded-full">Viva Prep</span>
                </div>
              </Link>
            </div>
            ...
            <div className="mt-10 flex justify-center">
              <div className="inline-flex items-center gap-3 rounded-full bg-slate-50 px-4 py-2 text-xs font-semibold text-slate-500 border border-slate-200">
      ...
      <footer className="bg-slate-950 border-t border-slate-900 text-slate-400 mt-20 pt-16 pb-8">
        <div className="mx-auto max-w-7xl px-6">
          <div className="grid gap-10 sm:grid-cols-2 md:grid-cols-12">
            ...
            {/* Col 3: Tools */}
            <div className="md:col-span-2 space-y-4">
              <h4 className="text-xs font-bold uppercase tracking-widest text-slate-200">Tools</h4>
              <ul className="space-y-2.5 text-xs font-medium">
                <li><Link to="/student/resume-builder" className="hover:text-emerald-400 transition-colors">Resume Builder</Link></li>
                <li><Link to="/student/projects" className="hover:text-emerald-400 transition-colors">Project Helper</Link></li>
                <li><Link to="/student/notes" className="hover:text-emerald-400 transition-colors">Smart Notes</Link></li>
                <li><Link to="/student/pyqs" className="hover:text-emerald-400 transition-colors">PYQ Vault</Link></li>
              </ul>
            </div>
