...
import { Loader2, Eye, EyeOff, ArrowRight, Database, Layers, Milestone, PlayCircle, FileText, ArrowUpRight, Sparkles } from "lucide-react";
      ...
      <div className="relative z-10 flex flex-col justify-between p-6 sm:p-10 md:col-span-6 lg:col-span-5 xl:col-span-4 bg-white border-r border-slate-200/60 shadow-xl shadow-slate-100">
        ...
        <div className="my-auto w-full max-w-[340px] mx-auto py-10">
          <div className="space-y-2.5">
            ...
            <h1 className="text-3xl font-black tracking-tight text-slate-950">Log In</h1>
          ...
          <div className="relative my-6 flex items-center justify-center text-[10px] font-bold uppercase tracking-widest text-slate-400">
            ...
            <span className="relative bg-white px-3 text-[9px]">Security Credentials</span>
          </div>
          ...
          <form onSubmit={onSubmit} className="space-y-4">
            ...
            <div className="space-y-1.5">
              <div className="flex items-center justify-between">
                ...
                {/* Optional Forgot Password feature link location */}
                <Link to="/signup" className="text-[10px] font-bold text-slate-400 hover:text-emerald-600 transition-colors hidden">Forgot?</Link>
              </div>
            ...
            >
              {loading ? (
                ...
                <span className="flex items-center justify-center gap-2">
                  Access Dashboard <ArrowRight className="h-4 w-4 text-emerald-400" />
                </span>
              )}
            </Button>
          </form>
        ...
        <div className="rounded-xl bg-slate-50 border border-slate-150 p-3.5 text-center">
          <p className="text-[10px] font-bold text-slate-400 leading-normal uppercase tracking-wider">
            Protected Ecosystem. Default credentials grant secure structural read privileges according to schema hierarchy profiles.
          </p>
        </div>
      </div>
